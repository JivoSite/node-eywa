...
const Axon = module.exports = function (opts, obs)
{
   ...
   let _uri = null, _cli = null, _wdt = null, _wd,
   ...
   const _watchdog = function ()
   {
      ...
      else if (_idle === _wd.ping) _write(eywa.PING);
      else if (_idle === _wd.kill) return _cli.close(true);
      let n;
      for (let i in _stack)
      {
         n = _stack[i];
